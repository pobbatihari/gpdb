...
-- InnerHashJoin should not generate a plan with new opt request (replicated, non-singleton)
...
-- InnerHashJoin should select rep1 as outer and universal as the inner child with one-time filter
